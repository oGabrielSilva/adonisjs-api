...
Route.get('/groups/:id/requests', 'GroupRequestsController.index').middleware('auth')
Route.post('/groups/:id/requests', 'GroupRequestsController.store').middleware('auth')
Route.post(
...
Route.patch('/groups/:id', 'GroupRequestsController.update').middleware('auth')
